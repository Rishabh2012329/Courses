	...
	return(
		<div  style={{padding:"20px",width:"100%",display:"flex",flexDirection:"column",bottom:"0px",height:"auto",alignItems:"center",backgroundColor:"purple",marginTop:"80px"}}>
			...
			<div style={{color:"white",width:"110px",display:"flex",flexDirection:"column",height:"100px",flexWrap:"wrap",justifyContent:"space-around",alignItems:"center"}}>
				...
				<div style={{borderLeft:`solid ${Color} 4px`,paddingLeft:"10px"}}>bikaner, ganganshahar</div>
			</div>
			...
			<div style={{color:"white",width:"150px",display:"flex",flexDirection:"column",height:"120px",justifyContent:"space-around"}}>
				...
				<div style={{borderLeft:`solid ${Color} 4px`,paddingLeft:"10px"}}>baid@gmail.com</div>
			...
			<div style={{height:"100%",display:"flex",alignItems:"bottom",color:"white"}}>@ 2021 Made By Rishabh</div>
		</div>
	);
}