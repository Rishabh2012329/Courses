    ...
    return (
        <div style={{width:"100%",display:'flex',flexDirection:"row",height:"70vh"}}>
            <div id="h1" style={{width:"50%",height:"100%",backgroundImage:"linear-gradient(to left,purple 30%,purple)",display:"flex",justifyContent:"center",alignItems:"center"}}>
                {!obj.isLogged?<div style={{maxWidth:"350px",height:"300px",display:"flex",flexDirection:"column",justifyContent:"space-between",alignItems:"center"}}>
                    <RoundButton func={()=>{
                        setteach(true)
                        sets(!shows)}} width="290px" height="60px" text="Signup as a Teacher" backgroundColor="orange" fontSize="23px" fontFamily="sans-serif"/>
                    <div style={{color:"white"}}>OR</div>
                    <RoundButton func={()=>{
                        setteach(false)
                        sets(!shows)}} width="290px" height="60px" text="Signup as a Learner" backgroundColor="orange" fontSize="23px" fontFamily="sans-serif"/>
